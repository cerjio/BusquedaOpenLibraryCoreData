...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let addButton = UIBarButtonItem(barButtonSystemItem: .Add, target: self, action: "showSearchView")
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if let indexPath = self.tableView.indexPathForSelectedRow {
            ...
            controller.titulo = object.valueForKey("titulo") as? String
        }
    ...
    func showSearchView() {
        ...
        let storyboard: UIStoryboard = UIStoryboard(name: "Main", bundle: nil) //UIStoryboard(name: "Main", bundle: nil)
        let svc: SearchViewController = storyboard.instantiateViewControllerWithIdentifier("Busqueda") as! SearchViewController
        
        svc.view.backgroundColor = UIColor.darkGrayColor()
